...
这是自然语言处理（NLP），更具体地说是文本分类，可以使用循环神经网络（RNN）和CNN来解决，但变压器效果更好（参见[第16章](ch16.html#nlp_chapter)）。
...
![mls3 0115](assets/mls3_0115.png)
...
让我们为这些国家的数据绘制图表（[图1-18](#money_happy_scatterplot)）。
