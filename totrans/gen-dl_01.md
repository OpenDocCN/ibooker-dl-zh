...
[第一部分](part01.xhtml#part_introduction)是生成建模和深度学习的一般介绍，我们在其中探讨了贯穿本书后续部分所有技术的核心概念：
...
+   [第9章](ch09.xhtml#chapter_transformer)是第一版结尾提供的材料的扩展，更深入地关注了各种StyleGAN模型的架构以及关于VQ-GAN的新材料。
